...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Huê - Trường PTDTBT Tiểu học Mậu Duệ B - ĐT: 0358 957 882</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Huê - Trường PTDTBT Tiểu học Mậu Duệ B - ĐT: 0358 957 882</div>", unsafe_allow_html=True)
